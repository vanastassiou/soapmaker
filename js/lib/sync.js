/**
 * Sync integration for soapmaker
 * Connects seneschal-core sync engine to soapmaker state
 */

import { createSyncEngine, createGoogleDriveProvider, hasOAuthCallback } from '../../core/js/index.js';
import { exportAllData, importUserData } from '../state/state.js';

const DOMAIN = 'soapmaker';
